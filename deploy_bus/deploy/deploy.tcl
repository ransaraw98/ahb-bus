...
#
# deploy.tcl: Tcl script for re-creating project 'deploy'
#
# Generated by Vivado on Fri Mar 24 17:15:13 +0530 2023
...
#
# 1. This project restoration tcl script (deploy.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ransara/Documents/ADS/AHB/deploy_bus/deploy/deploy.srcs/sources_1/bd/deploy/hdl/deploy_wrapper.v"
#
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/amba_ahb_1.0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/deploy.srcs/sources_1/bd/deploy/hdl/deploy_wrapper.v" ]\
]
...
set_property -name "top" -value "deploy_wrapper" -objects $obj
...
# Proc to create BD deploy
proc cr_bd_deploy { parentCell } {
  ...
  set amba_ahb_0 [ create_bd_cell -type ip -vlnv user.org:user:amba_ahb:4.0 amba_ahb_0 ]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins amba_ahb_0/resetn] [get_bd_pins amba_ahb_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1310 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1310 -y 40 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 270 -y 340 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1140 -y 150 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 750 -y 470 -defaultsOSRD
preplace inst vio_0 -pg 1 -lvl 2 -x 750 -y 90 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 2 -x 750 -y -50 -defaultsOSRD
preplace inst system_ila_1 -pg 1 -lvl 2 -x 750 -y 620 -defaultsOSRD
preplace inst system_ila_2 -pg 1 -lvl 2 -x 750 -y 920 -defaultsOSRD
preplace inst amba_ahb_0 -pg 1 -lvl 1 -x 270 -y 100 -defaultsOSRD
preplace netloc amba_ahb_0_dout1 1 1 1 510 -40n
preplace netloc amba_ahb_0_dout2 1 1 1 530 100n
preplace netloc amba_ahb_0_dout3 1 1 1 490 120n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 -20 520 190 960
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 480 430n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 3 30 -10 550J 180 970
preplace netloc processing_system7_0_FCLK_CLK1 1 1 1 540 -60n
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 40 0 500J 270 NJ 270 1290
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ 310 950
preplace netloc processing_system7_0_FIXED_IO 1 1 3 480J 260 940J 30 1290
preplace netloc processing_system7_0_DDR 1 1 3 NJ 250 930J 20 N
levelinfo -pg 1 0 270 750 1140 1310
pagesize -pg 1 -db -bbox -sgen 0 -120 1430 990
"
}
...
# End of cr_bd_deploy()
cr_bd_deploy ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files deploy.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files deploy.bd ] 
set_property IS_ENABLED "1" [get_files deploy.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files deploy.bd ] 
set_property IS_LOCKED "0" [get_files deploy.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files deploy.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files deploy.bd ] 
set_property PFM_NAME "" [get_files deploy.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files deploy.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files deploy.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files deploy.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files deploy.bd ] 
set_property USED_IN_SIMULATION "1" [get_files deploy.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files deploy.bd ] 
