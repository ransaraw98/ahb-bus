...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_ps7_0_10M1, and set properties
  set rst_ps7_0_10M1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_10M1 ]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets amba_ahb_0_hrdata_debug]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins amba_ahb_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_10M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins amba_ahb_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins rst_ps7_0_10M1/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET1_N [get_bd_pins processing_system7_0/FCLK_RESET1_N] [get_bd_pins rst_ps7_0_10M/ext_reset_in]
  connect_bd_net -net processing_system7_0_FCLK_RESET2_N [get_bd_pins processing_system7_0/FCLK_RESET2_N] [get_bd_pins rst_ps7_0_10M1/ext_reset_in]
  connect_bd_net -net rst_ps7_0_10M1_peripheral_aresetn [get_bd_pins amba_ahb_0/resetn] [get_bd_pins rst_ps7_0_10M1/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_10M_peripheral_aresetn [get_bd_pins amba_ahb_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_10M/peripheral_aresetn]
